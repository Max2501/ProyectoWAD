    ...
    <div class="Themes">
        <div class="container">
            <div class="feature-grids">
                <form method="post" action="PeliculaServlet?accion=actualizar&id=${pelis.idPelicula}">
                    <div class="col-md-4 feature-grid">
                        <h3>Nombre de la Película:</h3>
                        <p><input type="text" name="txtNombre" value="${pelis.nombre}" required/></p>
                        <h3>Duración:</h3>
                        <p><input type="text" name="txtDuracion" value="${pelis.duracion}" required/></p>
                        <h3>Género:</h3>
                        <p><input type="text" name="txtGenero" value="${pelis.genero}" required/></p>   
                    </div>
                    <div class="col-md-4 feature-grid">
                        <h3>Clasificación:</h3>
                        <p><input type="text" name="txtClasificacion" value="${pelis.clasificacion}" required/></p>
                        <h3>Resumen:</h3>
                        <p><input type="text" name="txtResumen" value="${pelis.resumen}"/></p>      
